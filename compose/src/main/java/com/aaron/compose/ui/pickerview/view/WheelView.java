package com.aaron.compose.ui.pickerview.view;
...
import com.aaron.compose.ui.pickerview.interfaces.IPickerViewData;
import com.aaron.compose.ui.pickerview.listener.LoopViewGestureListener;
import com.aaron.compose.ui.pickerview.listener.OnItemSelectedListener;
import com.aaron.compose.ui.pickerview.timer.InertiaTimerTask;
import com.aaron.compose.ui.pickerview.timer.MessageHandler;
import com.aaron.compose.ui.pickerview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public final void setTextSizePixels(int pixels) {
        if (pixels > 0) {
            textSize = pixels;
            paintOuterText.setTextSize(textSize);
            paintCenterText.setTextSize(textSize);
